		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#gmsgmsserviceprofile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gmsgmsserviceprofile-display": {
								"semanticObject": "gmsgmsserviceprofile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gms.gmsserviceprofile",
									"url": sap.ui.require.toUrl("gms/gmsserviceprofile")
								}
							}
						}
					}
